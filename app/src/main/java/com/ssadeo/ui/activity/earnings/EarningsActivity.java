...
import com.ssadeo.common.CircularProgressBar;
import com.ssadeo.data.network.model.EarningsList;
import com.ssadeo.data.network.model.Payment;
import com.ssadeo.data.network.model.Ride;
import com.ssadeo.ui.adapter.EarningsTripAdapter;
...
import static com.ssadeo.common.Utilities.animateTextView;
...
public class EarningsActivity extends BaseActivity implements EarningsIView {
    ...
    private void loadAdapter(EarningsList earningsLists) {
        ...
        earningsBar.setProgressWithAnimation(earningsLists.getRidesCount(), 1500,Integer.parseInt(earningsLists.getTarget()));

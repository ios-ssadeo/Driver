...
import com.ssadeo.common.RecyclerItemClickListener;
import com.ssadeo.data.network.model.Document;
import com.ssadeo.ui.activity.photoview.PhotoViewActivity;
...
public class DocumentActivity extends BaseActivity implements DocumentIView {
    ...
    public void pickImage() {
        if (hasPermission(Manifest.permission.CAMERA) && hasPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            requestPermissionsSafely(new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE},
